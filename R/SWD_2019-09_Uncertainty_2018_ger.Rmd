...
title <- ggplot(data.frame(x = 1:2, y = 1:10)) +
  labs(x = NULL, y = NULL,
       ...
       subtitle = "Verteilung der maximalen Tagestemperaturen pro Monat fpr den zeitraum 1. Januar 2000 bis 31. Dezember 2018, gemessen in Berlin-Dahlem") +
...
caption <- ggplot(data.frame(x = 1:2, y = 1:10)) +
  labs(x = NULL, y = NULL, 
       caption = "Visualisierung: Cédric Scherer  |  Datem: DWD (Deutscher Wetterdienst)") +
       theme(line = element_blank(),
